...
!function (e) {
  ...
  function r(e) {
    return e && e.__esModule ? e : { default: e };
      ...
      m = n(16),
      b = r(m),
      w = { _regions: [], Gesture: a.default, Expand: c.default, Pan: l.default, Pinch: p.default, Rotate: y.default, Swipe: g.default, Tap: b.default, Region: function Region(e, t, n) {
  ...
  function r(e) {
    ...
    function e(t, n, r, u) {
    ...
    }return u(e, [{ key: "bind", value: function value(e, t, n, r, i) {
      ...
      } }, { key: "bindOnce", value: function value(e, t, n, r) {
        this.bind(e, t, n, r, !0);
      } }, { key: "unbind", value: function value(e, t) {
        var n = this,
  ...
  function r(e) {
    ...
    function e() {
    ...
    }return u(e, [{ key: "setType", value: function value(e) {
        this.type = e;
      } }, { key: "getType", value: function value() {
        return this.type;
      } }, { key: "setId", value: function value(e) {
        this.id = e;
      ...
      } }, { key: "start", value: function value(e, t, n) {
        return null;
      } }, { key: "move", value: function value(e, t, n) {
        return null;
      } }, { key: "end", value: function value(e) {
        return null;
      } }, { key: "isValid", value: function value(e, t, n) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 });var n = 360,
      r = 180,
      i = { normalizeEvent: function normalizeEvent(e) {
      ...
      if (e.path) return e.path;for (var t = [], n = e.target; n != document;) {
  ...
  function r(e) {
    ...
    function e(t) {
    ...
    }return a(e, [{ key: "addBinding", value: function value(e, t, n, r, i) {
      ...
      } }, { key: "retrieveBindingsByElement", value: function value(e) {
        var t = [];return this.bindings.map(function (n) {
          n.element === e && t.push(n);
        }), t;
      } }, { key: "retrieveBindingsByInitialPos", value: function value() {
        var e = this,
      ...
      } }, { key: "updateInputs", value: function value(e, t) {
        function n(e, t, n, r) {
          var i = I.default.normalizeEvent(e.type),
            ...
            for (var o in e.changedTouches) {
              e.changedTouches.hasOwnProperty(o) && I.default.isInteger(parseInt(o)) && (r = e.changedTouches[o].identifier, n(e, this, r, t));
            }break;case "PointerEvent":
            r = e.pointerId, n(e, this, r, t);break;case "MouseEvent":default:
            n(e, this, T, t);}return !0;
      } }, { key: "resetInputs", value: function value() {
        this.inputs = [];
      } }, { key: "numActiveInputs", value: function value() {
        var e = this.inputs.filter(function (e) {
          return "end" !== e.current.type;
        });return e.length;
      } }, { key: "registerGesture", value: function value(e, t) {
        this.assignGestureId(e), this.registeredGestures[t] = e;
      } }, { key: "assignGestureId", value: function value(e) {
  ...
  function r(e) {
      ...
      i(this, t);var n = u(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));return n.type = "distance", n.threshold = e && e.threshold ? e.threshold : p, n;
    }return o(t, e), a(t, [{ key: "start", value: function value(e, t, n) {
        ...
        if (t.numActiveInputs() === d) {
          var r = l.default.distanceBetweenTwoPoints(e[0].current.x, e[1].current.x, e[0].current.y, e[1].current.y),
              ...
              o = e[0].getGestureProgress(this.type);if ("Expand" === this.constructor.name) {
  ...
  function r(e) {
    ...
    }return o(t, e), a(t, [{ key: "start", value: function value(e) {
  ...
  function r(e) {
    ...
    }return o(t, e), a(t, [{ key: "move", value: function value(e, t, n) {
        if (t.numActiveInputs() <= d) {
          var r = void 0,
              i = void 0,
              u = void 0,
        ...
        if (this.numInputs === e.length) {
          for (var t = { data: [] }, n = 0; n < e.length; n++) {
            if ("end" !== e[n].current.type) return;var r = e[n].getGestureProgress(this.getId());if (r.moves && r.moves.length > 2) {
              ...
              }u || (u = r.moves.pop(), u.time += this.timeDistortion);var a = l.default.getVelocity(u.x, u.y, u.time, i.x, i.y, i.time);t.data[n] = { velocity: a, distance: l.default.distanceBetweenTwoPoints(u.x, i.x, u.y, i.y), duration: i.time - u.time, currentDirection: l.default.getAngle(u.x, u.y, i.x, i.y) };
            }
  ...
  function r(e) {
    ...
    }return o(t, e), s(t, [{ key: "start", value: function value(e) {
  ...
  function r(e) {
    ...
    }return u(e, [{ key: "update", value: function value(e, t) {
        this.previous = this.current, this.current = new a.default(e, t);
      } }, { key: "getGestureProgress", value: function value(e) {
        return this.progress[e] || (this.progress[e] = {}), this.progress[e];
      } }, { key: "getCurrentEventType", value: function value() {
        return this.current.type;
      } }, { key: "resetProgress", value: function value(e) {
        this.progress[e] = {};
      } }]), e;
  }();t.default = s;
}, function (e, t, n) {
...
window.addEventListener('DOMContentLoaded', function () {
	...
	zt.bind(myElement, 'swipe', function (evt) {
