...
// render the mobile user elements
    ...
    var $userMobile = function (mobile_nav, user) {
        ...
        function _$userTile(user) {
            return $('div',
                {"class": clsPrefix.mobile_nav + '-user'},
                (user && user.name) ?
                    [
                        $('button',
                            {
                            ...
                            [$('img',
                                ...
                                $('span',
                                    ...
                                    [document.createTextNode('json@data')])
                            ])
                    ] :
                    [
                        $('button',
        ...
        function _$userDrawer(user) {
            return $('div',
                ...
                [$('div',
                    {class: clsPrefix.mobile_user + '-menu-info'},
                    [].concat(
                        $('ul',
                            {"class": clsPrefix.mobile_nav + "-sublist"},
                            [$('li',
                        ...
                        user.name ?
                            $('span',
                                {class: clsPrefix.mobile_user + '-menu-name'},
                                [document.createTextNode(user.name)]
                            ) : [],
                        user.id ?
                            $('span',
                                {class: clsPrefix.mobile_user + '-menu-id'},
                                [document.createTextNode(user.id)]
                            ) : [],
                        user.group ?
                            $('span',
                                {class: clsPrefix.mobile_user + '-menu-group'},
                    ...
                    $('ul',
                        ...
                        [
                            $('li',
                                {class: clsPrefix.mobile_user + '-menu-item'},
                                [$('a',
                                    {
